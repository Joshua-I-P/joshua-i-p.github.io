var background = function (window) {
    ...
    window.opspark.makeBackground = function(app,ground) {
        ...
        function render() {
            ...
            for (var i = 1; i <= 150; i++){
                var star = draw.circle(5, 'white', 'light gray', 2);
            ...
            for (var i = 0; i <= 10; ++i) {
             var buildingHeight = Math.random() * (500 - 150) + 150;
        ...
        function update() {
            ...
            for (var i = 0; i < buildings.length; i++){
               var oneBuilding = buildings[i]
                oneBuilding.x = oneBuilding.x - 2
                if (oneBuilding.x < -200){
                    oneBuilding.x = canvasWidth
                }
            }
